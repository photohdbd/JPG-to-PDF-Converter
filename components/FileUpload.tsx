  ...
  return (
    <div className="w-full max-w-2xl text-center">
      ...
      >
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-white">Drag & Drop Your Images Here</h2>
        ...
        />
        <p className="text-xs text-gray-500 mt-4">Supports JPG, PNG, WEBP, GIF, and more</p>
      </div>
    </div>
  );
};