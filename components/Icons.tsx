...
export const LoaderIcon: React.FC<IconProps> = (props) => (
  <div {...props} className="flex space-x-2">
    ...
    `}</style>
    <div className="dot dot-1 bg-brand-primary"></div>
    <div className="dot dot-2 bg-brand-primary"></div>
    <div className="dot dot-3 bg-brand-primary"></div>
  </div>
);
...
export const Layers2Icon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m16.5 7.5 4.5-4.5" />
        <path d="m3 3 18 18" />
        <path d="m21 16-4-4" />
        <path d="m11.5 5.5-5 5" />
        <path d="m16 12-1.5 1.5" />
        <path d="m3 8 4 4" />
        <path d="M9.5 21a6.5 6.5 0 0 1-6.2-8.8" />
        <path d="M21 14.5a6.5 6.5 0 0 1-8.8 6.2" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.9 8.2,4.73 12.19,4.73C14.03,4.73 15.6,5.33 16.84,6.46L19.09,4.22C17.21,2.56 14.8,1.5 12.19,1.5C7.03,1.5 3,5.55 3,12C3,18.6 6.94,22.5 12.19,22.5C17.6,22.5 21.5,18.33 21.5,12.91C21.5,11.76 21.45,11.44 21.35,11.1Z"/>
    </svg>
);
...
export const MoonIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"></path></svg>
);

// Icons for PDF Editor
export const TypeIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="4 7 4 4 20 4 20 7"></polyline><line x1="9" y1="20" x2="15" y2="20"></line><line x1="12" y1="4" x2="12" y2="20"></line></svg>
);
...
export const MousePointerIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 3 7.07 16.97 2.51-7.39 7.39-2.51L3 3z"></path><path d="m13 13 6 6"></path></svg>
);

export const SignatureIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10.5c0-2.5-2-2.5-2-2.5s-2.3-0.4-3.5-1.5c-1.2-1.1-1.5-2.5-1.5-2.5s0-2-2.5-2H10c-2.5 0-2.5 2-2.5 2s-0.3 1.4-1.5 2.5C4.8 9.6 2.5 10 2.5 10s-2 0-2 2.5c0 2.5 2 2.5 2 2.5s2.3 0.4 3.5 1.5c1.2 1.1 1.5 2.5 1.5 2.5s0 2 2.5 2H12c2.5 0 2.5-2 2.5-2s0.3-1.4 1.5-2.5c1.2-1.1 3.5-1.5 3.5-1.5s2 0 2-2.5z"></path></svg>
);
